...
import DeveloperBug from './DeveloperBug';
function DeveloperWholeProject() {
    ...
    return ( 
        <div >
            ...
            <div className='commentscontainer'>
                {bugs.map(bug=><DeveloperBug id={bug.id} status={bug.status} deadline={bug.deadline} userId={users[bug.userID-1]?.name} projectId={bug.projectID} title={bug.title} description={bug.description} />)}
            </div>
...
export default DeveloperWholeProject;